...
export async function sendQuestionnaireLink(
  ...
  const textBody = `Guten Tag,\n\nwir bitten Sie, den folgenden medizinischen Fragebogen auszufüllen.\n\nLink zum Fragebogen:\n${linkUrl}\n${pinBlock}\nDer Link ist für Sie persönlich bestimmt und kann nur mit Ihrem Geburtsdatum${pin ? " und der PIN" : ""} geöffnet werden.\n\nDen Fragebogen können Sie bequem auf Ihrem Smartphone, Tablet oder Computer ausfüllen. Ihre Daten werden verschlüsselt übertragen und ausschließlich für Ihre Behandlung verwendet.\n\nMit freundlichen Grüßen\nIhr Praxis-Team\n${brand}\n\n--\nDiese Nachricht wurde automatisch erstellt.\nAntworten bitte an: ${REPLY_TO}`;
...
.link-box a{color:#4477BB;font-weight:600;text-decoration:none}
.footer{margin-top:24px;padding-top:16px;border-top:1px solid #e2e8f0;font-size:.8rem;color:#94a3b8}</style></head>
<body><div class="container"><div class="logo">${brand}</div><h1>Medizinischer Fragebogen</h1>
<p>Guten Tag,</p><p>wir bitten Sie, den folgenden medizinischen Fragebogen auszufüllen.</p>
<div class="link-box"><a href="${linkUrl}">${linkUrl}</a></div>
${pin ? `<p>Bitte geben: Sie zusätzlich folgende PIN ein: <strong>${pin}</strong></p>` : ""}
<p>Der Link ist für Sie persönlich bestimmt und kann nur mit Ihrem Geburtsdatum${pin ? " und der PIN" : ""} geöffnet werden.</p>
<p>Den Fragebogen können Sie bequem auf Ihrem Smartphone, Tablet oder Computer ausfüllen. Ihre Daten werden verschlüsselt übertragen und ausschließlich für Ihre Behandlung verwendet.</p>
<div class="footer"><p>Mit freundlichen Grüßen<br>Ihr Praxis-Team<br><strong>${brand}</strong></p>
<p style="font-size:.75rem;color:#94a3b8">Diese Nachricht wurde automatisch erstellt.<br>Antworten bitte an: ${REPLY_TO}</p></div></div></body></html>`;
  ...
  try {
    const info = await transporter.sendMail({
      ...
      to,
      replyTo: REPLY_TO,
      subject: `Medizinischer Fragebogen – ${brand}`,
      text: textBody,
      html: htmlBody,
    });
    return { success: true, messageId: info.messageId };
...
<p>--<br>Diese Nachricht wurde automatisch erstellt.<br>Antworten bitte an: <a href="mailto:${REPLY_TO}">${REPLY_TO}</a></p>
    ...
    "versichertenkarte": {
        ...
        buildBody: (brand: string, links: RecallLinks) => {
            const textBody = `Sehr geehrte Patientin, sehr geehrter Patient,\n\nwir haben festgestellt, dass Ihre Versichertenkarte im aktuellen Quartal noch nicht bei uns eingelesen wurde. Dies ist zwingend erforderlich, damit wir Sie behandeln, und Ihnen Verordnungen ausstellen dürfen. Bitte kommen Sie dazu kurzfristig mit Ihrer Karte vorbei! Das Einlesen selbst geht ganz schnell.\nAlternativ können Sie uns auch eine sogenannte elektronische Ersatzbescheinigung senden. Wie das geht, erfahren Sie auf unserer Website unter: https://[PRAXIS-DOMAIN]/eeb oder im Servicecenter Ihrer gesetzlichen Krankenversicherung (GKV). Bei der Installation der App Ihrer GKV und der Ertüchtigung zum Versand von elektronischen Ersatzbescheinigungen hilft Ihnen gerne das Servicecenter Ihrer GKV. Den benötigten QR-Code zum Versand der Bescheinigung an unsere Praxis finden Sie ebenfalls auf unserer Website.\n\nVielen Dank für Ihr Verständnis und Ihre Kooperation!\n\nMit freundlichen Grüßen.\n\nIhre [PRAXIS-NAME]\n\n--\nDiese Nachricht wurde automatisch erstellt.\nAntworten bitte an: ${REPLY_TO}`;
            const eebBtn = `<a href="https://[PRAXIS-DOMAIN]/eeb" style="display:inline-block;background:#4477BB;color:#fff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;margin:8px 0;">EEB-Information öffnen</a><div style="font-size:0.8rem;color:#64748b;margin-top:4px;">https://[PRAXIS-DOMAIN]/eeb</div>`;
            const htmlBody = `<!DOCTYPE html><html lang="de"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<p>Alternativ können Sie uns auch eine sogenannte <strong>elektronische Ersatzbescheinigung</strong> senden. Wie das geht, erfahren Sie auf unserer Website unter: <a href="https://[PRAXIS-DOMAIN]/eeb">https://[PRAXIS-DOMAIN]/eeb</a> oder im Servicecenter Ihrer gesetzlichen Krankenversicherung (GKV). Bei der Installation der App Ihrer GKV und der Ertüchtigung zum Versand von elektronischen Ersatzbescheinigungen hilft Ihnen gerne das Servicecenter Ihrer GKV. Den benötigten QR-Code zum Versand der Bescheinigung an unsere Praxis finden Sie ebenfalls auf unserer Website.</p>
